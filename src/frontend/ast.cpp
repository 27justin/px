...
SP<ast_node_t>
make_node(ast_node_t::kind_t kind, source_location_t loc, SP<source_t> source) {
  ...
  switch (kind) {
    ...
    case eCall:
      ...
      if (other.as.call_expr->implicit_receiver)
        as.call_expr->implicit_receiver =
          std::make_shared<ast_node_t>(*other.as.call_expr->implicit_receiver);
    ...
    case eMove:
      ...
      break;
    case eArrayAccess:
      as.array_access_expr->value =
        std::make_shared<ast_node_t>(*other.as.array_access_expr->value);
      as.array_access_expr->offset =
        std::make_shared<ast_node_t>(*other.as.array_access_expr->offset);
      break;
    case eSliceExpr:
...
ast_node_t::reset() {
  switch (kind) {
    ...
    case eFunctionImpl:
      delete as.fn_impl;
      break;
    case eFunctionParameter:
      delete as.fn_param;
      break;
    case eReturn:
      delete as.return_stmt;
      break;
    case eCall:
      delete as.call_expr;
      break;
    case eLiteral:
      delete as.literal_expr;
      break;
    case eMemberAccess:
      delete as.member_access;
      break;
    case eAddrOf:
      delete as.addr_of;
      break;
    case eIf:
      ...
      break;
    case eTypeAlias:
      delete as.alias_decl;
      break;
    case eCast:
      delete as.cast;
      break;
    case eAssignment:
      delete as.assign_expr;
      break;
    case eDeref:
      delete as.deref_expr;
      break;
    case eAttribute:
      delete as.attribute_decl;
      break;
    case eFor:
      delete as.for_stmt;
      break;
    case eWhile:
      delete as.while_stmt;
      break;
    case eBinding:
      delete as.binding_decl;
      break;
    case eStructExpr:
      delete as.struct_expr;
      break;
    case eRangeExpr:
      delete as.range_expr;
      break;
    case eContract:
      delete as.contract_decl;
      break;
    case eDefer:
      delete as.defer_expr;
      break;
    case eMove:
      delete as.move_expr;
      break;
    case eTemplate:
      delete as.template_decl;
      break;
    case eArrayAccess:
      delete as.array_access_expr;
      break;
    case eSizeOf:
      delete as.sizeof_expr;
      break;
    case eSliceExpr:
      delete as.slice_expr;
      break;
    case eArrayInitializeExpr:
      delete as.array_initialize_expr;
      break;
    case eTupleExpr:
      delete as.tuple_expr;
      break;
    case eEnumDecl:
      delete as.enum_decl;
      break;
...
void
dump_ast(ast_node_t &node, size_t indent_val) {
  ...
  switch (node.kind) {
    ...
    case ast_node_t::eWhile: {
      ...
      std::cout << "[While ";
      dump_ast(*stmt->condition, indent_val + 1);
      std::cout << "\n";
    ...
    case ast_node_t::eFor: {
      ...
      if (stmt->init) {
        std::cout << indent();
        dump_ast(*stmt->init, indent_val + 1);
        std::cout << "\n";
      }
      if (stmt->condition) {
        std::cout << indent();
      ...
      if (stmt->action) {
        std::cout << indent();
        dump_ast(*stmt->action, indent_val + 1);
        std::cout << "\n";
      }
      std::cout << indent();
      dump_ast(*stmt->body, indent_val + 2);
      std::cout << "\n";
      std::cout << "]\n";
      return;
    }
    ...
    case ast_node_t::eAssignment: {
      ...
      std::cout << "[Assign \n";
      dump_ast(*expr->where, indent_val + 1);
      std::cout << "\n";
    ...
    case ast_node_t::eFunctionImpl: {
      ...
      for (auto &param : decl.parameters) {
        std::cout << indent() << "  " << (param.is_self ? "(self) " : "") << to_string(param.name)
...
std::string
to_string(const type_decl_t &type) {
  std::stringstream ss;
  if (type.is_mutable)
    ss << "var ";
